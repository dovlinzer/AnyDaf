# Chullin 18 — Daf Yomi Shiur
[DAF:18a]

## Three Types of Nicks

### Opening & Rav Huna

> **Hebrew/Aramaic:** אָמַר רַב הוּנָא בַּר רַב קַטִּינָא אָמַר רַבִּי שִׁמְעוֹן בֶּן לָקִישׁ, שָׁלֹשׁ פְּגִימוֹת הֵן: פְּגִימַת עֶצֶם בַּפֶּסַח, פְּגִימַת אוֹזֶן בִּבְכוֹר, פְּגִימַת מוּם בְּקָדָשִׁים.
>
> **Translation:** § **Rav Huna bar Rav Ketina says** that **Rabbi Shimon ben Lakish says** that **there are three deficiencies** with the same measure, as follows: **The deficiency of a bone in the Paschal offering,** with regard to which it is written: "Neither shall you break a bone therein" (Exodus 12:46); **the deficiency of an ear in a firstborn** animal that renders it blemished and unfit for sacrifice, in which case a priest may slaughter it anywhere and eat it; and **the deficiency** that constitutes **a blemish in** other forms of **sacrificial** animals.

Daf 18 begins at the bottom of 17b, where the Gemara turns to the real details of the act of shechita itself. The opening statement is that of Rav Huna bar Kattina, citing Rabbi Shimon ben Lakish.

### Three Pegimot Categories

> **Hebrew/Aramaic:** וְרַב חִסְדָּא אָמַר: אַף פְּגִימַת סַכִּין. וְאִידַּךְ בְּחוּלִּין לָא קָא מַיְירֵי.
>
> **Translation:** **And Rav Ḥisda says:** There is **the deficiency of a knife as well.** The Gemara asks: **And the other** *amora*, Rabbi Shimon ben Lakish, why does he not include the knife? The Gemara answers: He does not include it because **he is not speaking with regard to non-sacred** animals.

Rabbi Shimon ben Lakish declares: there are three types of nicks that are related to one another in terms of what defines a nick and where a nick constitutes a halachic problem.

The first is a nick in a bone on Pesach. The Torah states *kol etzem lo tishberu vo*, that no bone may be broken. Surprisingly, one might have thought that breaking a bone meant snapping it in two; in fact, even nicking a bone constitutes a violation of this prohibition. The second is a nick in the ear of a bechor, which constitutes a mum and thereby permits the animal to be slaughtered and eaten outside the Beit Hamikdash. The ear is mentioned because it appears first in the list of mumim applicable to a bechor. The third is a nick that creates a blemish in kodashim, rendering the animal unfit to be brought as a korban and requiring a transfer of kedusha.

A fourth opinion is then introduced: Rav Chisda adds that a nick in a knife is equally governed by the same standard. The Gemara notes that the earlier tanna did not include the knife because that discussion pertained to non-kodashim contexts. The essential point of grouping all of these together is not merely that nicks are problematic in various domains, but that they all share the same definition of what constitutes a nick: in every case, the standard is that of the nick of the altar.
...
> **Hebrew/Aramaic:** וְכוּלָּן, פְּגִימָתָן כְּדֵי פְּגִימַת הַמִּזְבֵּחַ.
>
> **Translation:** Rav Ḥisda continues: **And** with regard to **all of** these deficiencies, **the measure of their deficiency** is **equivalent to** the measure of **deficiency** that renders **the altar** unfit.

The common thread uniting all of these nicks — the bone on Pesach, the ear of the bechor, the blemish in kodashim, and the nick in a knife — is that their shared definition derives from the standard of the altar: that the nick is of sufficient size that a fingernail running across it would catch. That is the operative measure in every one of these contexts.

---

## Nick Definition & Altar

### Altar Nick Definition

> **Hebrew/Aramaic:** וְכַמָּה פְּגִימַת הַמִּזְבֵּחַ? כְּדֵי שֶׁתַּחְגּוֹר בָּהּ צִפּוֹרֶן.
>
> **Translation:** **And how much** is **the deficiency** that renders **the altar** unfit? It is a deficiency that is **sufficient for a fingernail to be impeded on it.**

Having established that the standard for all these nicks is that of the altar, the Gemara now asks: what exactly is that standard? The answer given is that if you run your finger across it, it gets caught. This is precisely the standard that had been discussed in connection with knives used for shechita: any nick sufficient to catch a fingernail is considered a nick in the altar, and thereby constitutes the operative measure for all related domains.

### Baraita: Tefach vs. Keza…

> **Hebrew/Aramaic:** מֵיתִיבִי: כַּמָּה פְּגִימַת הַמִּזְבֵּחַ? רַבִּי שִׁמְעוֹן בֶּן יוֹחַאי אוֹמֵר: טֶפַח, רַבִּי אֱלִיעֶזֶר בֶּן יַעֲקֹב אוֹמֵר: כְּזַיִת. לָא קַשְׁיָא: הָא בְּסִידָא, הָא בְּאַבְנָא.
>
...
## Butcher & Knife Display

### Rav Huna's Cherem

> **Hebrew/Aramaic:** אָמַר רַב הוּנָא: הַאי טַבָּחָא דְּלָא סָר סַכִּינָא קַמֵּי חָכָם – מְשַׁמְּתִינַן לֵיהּ, וְרָבָא אֲמַר: מְעַבְּרִינַן לֵיהּ, וּמַכְרְזִינַן אַבִּשְׂרֵיהּ דִּטְרֵפָה הִיא.
>
> **Translation:** § Apropos the obligation to show the knife to a Torah scholar, **Rav Huna says: This slaughterer who did not present [*sar*] the knife before** a Torah **scholar, we ostracize him. And Rava says: We remove him** from his position **and we proclaim about meat** from an animal **that he** slaughtered **that it is *tereifa*.**

The Gemara continues with a ruling of Rav Huna: a butcher who does not show his knife to a sage is placed in cherem. Rashi explains that the reason is because of disrespect. The word *apikoros*, as the Gemara in Sanhedrin explains, does not here mean heresy but rather refers to one who is disrespectful of authority, specifically rabbinic authority. The butcher who refuses to show his knife is acting with *chutzpah*, failing to show proper deference, and is therefore subject to this sanction.

### Rava's Deposition

Rava goes further: one removes him from his post entirely — and publicly announces that all of his meat should be considered treifah. This is a significantly more severe consequence.

### Reconciling Rav & Rava

> **Hebrew/Aramaic:** וְלָא פְּלִיגִי, כָּאן – בְּשֶׁנִּמְצֵאת סַכִּינוֹ יָפָה, כָּאן – בְּשֶׁלֹּא נִמְצֵאת סַכִּינוֹ יָפָה. רָבִינָא אָמַר: הֵיכָא דְּלֹא נִמְצֵאת סַכִּינוֹ יָפָה – מְמַסְמֵס לֵיהּ בְּפַרְתָּא, דַּאֲפִילּוּ לְגוֹיִם נָמֵי לָא מִזְדַּבַּן.
>
...
The Gemara moves to reconcile these two positions: they do not actually disagree. The distinction is whether, upon examination, his knife was found to be acceptable or not. If the knife ultimately was found to be in good condition, then his only failing was a lack of deference to the sage, and for that he is placed in cherem — a serious but not permanent sanction from which he can presumably emerge through teshuvah. If, however, his knife was not in good condition, then he was not merely disrespectful but actively deceptive, attempting to conceal the fact that he was performing shechita with a defective knife. In that case, his meat is announced as treifah and he is removed from his post.

### Ravina's Extra Penalty

Ravina adds a still more severe layer. Where the knife is found to be defective — meaning not only disrespect but actual deception — one does not stop at the natural halachic consequence of declaring the meat treifah. Rather, one would literally drag the meat through dung — to prevent him even from selling it to a non-Jew. The reasoning is twofold: not only has he produced treifah meat, but he has done so knowingly and deceptively. Accordingly, not only the obvious halachic consequence must follow, but additional punitive measures must be taken to prevent such conduct in the future.
...
One might ask whether this is a matter of personal honor or of communal culture. The answer lies in recognizing that the culture of respecting rabbinic authority is itself a prerequisite for the effective functioning of halachic observance. The Gemara in Sanhedrin is full of cases where niduy is imposed specifically for disrespect of rabbinic authority, and the concern is not personal but systemic: if a culture develops in which a butcher feels he need not show his knife to the rav, then when rabbinic authorities attempt to enforce genuine standards — whether in kashrus or in other areas — they have no basis of authority from which to do so. This point is reinforced by historical examples where butchers who wished to evade kashrus standards did so precisely by undermining the authority of the supervising rabbi.

At the same time, the discussion has real contemporary resonance in the area of hashgacha. A community may restrict itself to a single hashgacha even where another is halachically sound, and the dynamics of rabbinic authority — and the limits on how far that authority may appropriately extend — are very much alive in this sugya. The Gemara's concern, it would seem, was genuinely about creating the conditions for halachic observance rather than about personal prestige, though the line between the two is not always easy to draw in practice.
...
> **Hebrew/Aramaic:** הָהוּא טַבָּחָא דְּלָא סָר סַכִּינָא קַמֵּיהּ דְּרָבָא בַּר חִינָּנָא, שַׁמְּתֵיהּ וְעַבְּרֵיהּ, וְאַכְרֵיז אַבִּשְׂרֵיהּ דִּטְרֵפָה הִיא. אִקְּלַעוּ מָר זוּטְרָא וְרַב אָשֵׁי לְגַבֵּיהּ, אֲמַר לְהוּ: לִיעַיְּינוּ רַבָּנַן בְּמִלְּתֵיהּ, דִּתְלוּ בֵּיהּ טַפְלֵי.
>
> **Translation:** There was **a certain slaughterer who did not present his knife before Rava bar Ḥinnana.** Rava bar Ḥinnana **ostracized him, and removed him** from his position, **and proclaimed about meat** from an animal **that he** slaughtered **that it is *tereifa*. Mar Zutra and Rav Ashi happened before** Rava bar Ḥinnana in his place of residence. Rava bar Ḥinnana **said to them: Let the Sages examine the matter of** the slaughterer, **as small children are dependent upon him.**

The Gemara now presents a narrative that crystallizes these tensions. There was a butcher who refused to show his knife to Rabba Bar Bar Chana. Rabba Bar Bar Chana, following the more severe position, placed him in cherem, removed him from his post, and announced that the meat was treifah.
...
### Knife Found Acceptable

> **Hebrew/Aramaic:** בַּדְקֵהּ רַב אָשֵׁי לְסַכִּינֵיהּ, וְנִמְצֵאת יָפָה, וְאַכְשְׁרֵיהּ. אֲמַר לֵיהּ מָר זוּטְרָא: וְלָא לֵיחוּשׁ מָר לְסָבָא? אֲמַר לֵיהּ: שְׁלִיחוּתֵיהּ קָא עָבְדִינַן.
>
> **Translation:** **Rav Ashi examined his knife and it was discovered intact, and he deemed** his meat **fit** for consumption. **Mar Zutra said to** Rav Ashi: **And shouldn't the Master be concerned for** the honor of **the elder,** Rava bar Ḥinnana, who removed him from his position and you restored him? Rav Ashi **said to** Mar Zutra: **We are carrying out his agency,** as he requested that we examine the matter of the slaughterer.

Rav Ashi examined the knife and found it to be acceptable — *ve'nimtzas yafa*. He thereupon declared the shechita kosher and permitted the butcher to return to work. Mar Zutra then challenged Rav Ashi: was he not concerned for the elder — *velo leichush Mar l'Saba* — meaning that by taking the more lenient position he was effectively overriding the ruling of Rabba Bar Bar Chana, who had proceeded on the assumption that the butcher should be deposed regardless of the knife's quality?

### Rav Ashi's Justification

Rav Ashi replied: I am carrying out his instructions. Rabba Bar Bar Chana himself had asked them to find a way to help this man. Rav Ashi found that the knife was acceptable and could therefore rely on the position that, where the knife is in fact good, the appropriate response is cherem rather than deposition from his post — and on that basis he reinstated him.
...
### Detached Tools Valid

> **Hebrew/Aramaic:** אָמַר רַבָּה בַּר הוּנָא: שֵׁן תְּלוּשָׁה וְצִפּוֹרֶן תְּלוּשָׁה מוּתָּר לִשְׁחוֹט בָּהּ לְכַתְּחִלָּה. וְהָא אֲנַן תְּנַן: חוּץ מִמַּגַּל קָצִיר וְהַמְּגֵירָה וְהַשִּׁינַּיִם וְהַצִּפּוֹרֶן, מִפְּנֵי שֶׁהֵן חוֹנְקִין.
>
> **Translation:** § **Rabba bar Huna says: With a detached tooth and a detached fingernail, it is permitted to slaughter *ab initio*.** The Gemara asks: **But didn't we learn** in the mishna (15b): **Except for the harvest sickle, and the saw, and the teeth, and the fingernail, because they strangle?**

The Gemara returns to the Mishna's discussion of the tools with which shechita may be performed. Raba bar Rav Huna states that a detached tooth — *sheit shluchos* — and a detached fingernail — *tziporen tlushah* — may be used for shechita, and indeed may be used *lechatchila*, at the outset. The logic is straightforward: one may use a rock or a reed for shechita, and these items, once detached, are no different in principle.

### Mishna: Prohibition

The Mishna, however, states that a harvest sickle, a saw, teeth, and a fingernail may not be used for shechita — because they cause the animal to choke rather than cut cleanly. The various items listed are serrated and produce a choking effect rather than the clean incision required.

### Attached vs. Detached

> **Hebrew/Aramaic:** שֵׁן אַשֵּׁן – לָא קַשְׁיָא: הָא בַּחֲדָא, הָא בְּתַרְתֵּי. צִפּוֹרֶן אַצִּפּוֹרֶן – לָא קַשְׁיָא: הָא בִּתְלוּשָׁה, הָא בִּמְחוּבֶּרֶת.
>
> **Translation:** The Gemara answers that the contradiction between this statement with regard to **a tooth and** that statement with regard to **a tooth** is **not difficult: This** statement of Rava bar Huna that one may slaughter with a tooth is referring to slaughter **with one** tooth. **That** mishna that prohibits slaughter with teeth is referring to slaughter **with two** teeth, as due to the gap between them they rip the *simanim*. The contradiction between the statement with regard to **a fingernail and** the statement with regard to **a fingernail** is **not difficult: This** statement of Rava bar Huna that one may slaughter with a fingernail is referring to slaughter **with a detached** fingernail. **That** mishna that prohibits slaughter with a fingernail is referring to slaughter **with an attached** fingernail, in accordance with the opinion of Rabbi Yehuda HaNasi (15b), who invalidates slaughter performed with an item attached to the ground or a living animal.

The Gemara resolves the apparent contradiction. With respect to the tooth: *shein ashein lo kashya, ha b'chada ha b'tartei*. The Mishna uses the plural *shinayim* — teeth. If two attached teeth are used together, the gap between them creates a serrated, uneven surface even if each individual tooth has been smoothed. With respect to the fingernail: the distinction is between a detached nail and an attached one. A detached fingernail may be used; an attached one presents the same problem as an implement attached to the ground — which, per the principle articulated by Rebbi that only a detached implement is valid, would render the shechita invalid.

---

## Harvest Sickle Debate

### Sickle Direction Debate

> **Hebrew/Aramaic:** מַתְנִי׳ הַשּׁוֹחֵט בְּמַגַּל קָצִיר, בַּדֶּרֶךְ הֲלִיכָתָהּ – בֵּית שַׁמַּאי פּוֹסְלִין, וּבֵית הִלֵּל מַכְשִׁירִין. וְאִם הֶחְלִיקוּ שִׁינֶּיהָ – הֲרֵי הִיא כְּסַכִּין.
>
...
Having concluded the discussion of the implements used for shechita, the Gemara turns to the question of where in the neck the shechita must be performed. The trachea — *kanah* — has a distinctive anatomical structure: it is surrounded by cartilaginous rings that are visible and palpable. Near the top there is a large ring — a substantial structure beneath which the epiglottis sits — and beneath it are a series of smaller individual rings that do not extend entirely around the circumference of the trachea. The valid zone for shechita extends from somewhere within this large top structure all the way down to the lungs.
...
> **Hebrew/Aramaic:** גְּמָ׳ רַב וּשְׁמוּאֵל דְּאָמְרִי תַּרְוַיְיהוּ: הֲלָכָה כְּרַבִּי יוֹסֵי בְּרַבִּי יְהוּדָה, וְאַף רַבִּי יוֹסֵי בְּרַבִּי יְהוּדָה לֹא אָמַר אֶלָּא בְּטַבַּעַת הַגְּדוֹלָה, הוֹאִיל וּמַקֶּפֶת אֶת כׇּל הַקָּנֶה, אֲבָל בִּשְׁאָר טַבָּעוֹת – לֹא.
>
> **Translation:** GEMARA: It is **Rav and Shmuel who both say:** The ***halakha*** is **in accordance with** the opinion of **Rabbi Yosei, son of Rabbi Yehuda. And even Rabbi Yosei, son of Rabbi Yehuda, says** his statement **only with regard to the large** upper **ring, since it encircles the entire windpipe, but with regard to the rest of the rings,** which are incomplete and where a strip of flesh connects their edges, he did **not** state his *halakha*. Therefore, his slaughter is not valid, as he is required to slaughter in the space between those rings and not in the rings themselves.

The psul of hagrama occurs when the knife moves outside the valid shechita zone during the act of shechita. The scenario under discussion is as follows: the shochet is performing shechita at the very top edge of the valid zone, directly at the limit of the *makom hashechita*. The question concerns what happens when the majority of the siman — the trachea — has been cut within the valid zone, but the shochet's knife then moves beyond the upper boundary before the cut is complete.

To understand what "majority" means here: the relevant measure is not the thickness of the walls of the trachea but the diameter of its hollow. One must cut through more than half the hollow of the tube. If the first fifty-one percent of this cut is performed within the valid zone and the remaining minority is completed outside it, does the shechita remain valid?

The tanna kamma holds that the entire cut is relevant: even if the majority was performed properly, finishing the cut in an invalid location constitutes hagrama and disqualifies the shechita.
...
The Gemara records that Rav and Shmuel both rule like Rabbi Yose beRabbi Yehuda. Rabbi Yose beRabbi Yehuda takes the lenient position: as long as the majority of the ring was cut within the valid zone, the shechita is valid even if the knife moved out of the valid zone for the remaining minority. He holds that once the majority is completed properly, the shechita is done, and what occurs in the last minority does not affect its validity.

### Rav & Shmuel Ruling

This ruling makes shechita more manageable in practice, as the shochet need not be concerned about where the knife finishes once the majority of the siman has been cut in the valid zone. The question then arises whether this ruling of leniency applies uniformly to all the other psulim of shechita — such as shehiya and drasa — in their final minority; that question will be addressed separately.

---

## Lower Rings Shechita

### Top Ring Only

> **Hebrew/Aramaic:** וּבִשְׁאָר טַבָּעוֹת לֹא? וְהָתַנְיָא: רַבִּי יוֹסֵי בְּרַבִּי יְהוּדָה אוֹמֵר:
>
> **Translation:** The Gemara objects: **And with regard to the rest of the rings,** Rabbi Yosei, son of Rabbi Yehuda, did **not** state his *halakha*; **but isn't it taught** in a *baraita* that **Rabbi Yosei, son of Rabbi Yehuda, says:**

The Gemara adds a qualification: even Rabbi Yose beRabbi Yehuda stated his lenient ruling only with respect to the large top ring, because that ring completely encircles the trachea. With respect to the other, lower rings, his ruling does not apply.
...
There is a third reading that Rashi acknowledges as a possible reading of the Gemara — that the requirement to remain within a ring applies not just to the top ring but to any ring in which the shechita is being performed, such that the knife must not leave the ring before the cut is complete. Rashi rejects this reading both because it lacks an obvious conceptual basis and because it would make valid shechita practically very difficult to achieve. However, it does render certain passages of the Gemara more readable.

[DAF:18b]
### Baraita Support

> **Hebrew/Aramaic:** הַשּׁוֹחֵט בִּשְׁאָר טַבָּעוֹת, אַף עַל פִּי שֶׁאֵין מַקִּיפוֹת אֶת כׇּל הַקָּנֶה, הוֹאִיל וּמַקִּיפוֹת אֶת רוֹב הַקָּנֶה – שְׁחִיטָתוֹ כְּשֵׁרָה, וּמוּגְרֶמֶת פְּסוּלָה. הֵעִיד רַבִּי חֲנִינָא בֶּן אַנְטִיגְנוֹס עַל מוּגְרֶמֶת שֶׁהִיא כְּשֵׁרָה.
>
> **Translation:** With regard to **one who slaughters** from **within the rest of the rings, even though they do not encircle the entire windpipe, since they encircle the majority of the windpipe his slaughter is valid.** The *baraita* adds: **And** in a case where the knife **is diverted** from the place of slaughter above the ring, the slaughter is **not valid. Rabbi Ḥanina ben Antigonus testified about** a case where the knife **is diverted** from the area of slaughter above the ring **that** in such a case the slaughter is **valid.** Contrary to that which Rav and Shmuel said with regard to the opinion of Rabbi Yosei, son of Rabbi Yehuda, he holds that slaughter from within the other rings is valid.

The Gemara introduces a Baraita in support of the view that shechita in the lower rings is valid. Rabbi Yosef beRabbi Yehuda says: one who performs shechita in the other rings — even though those rings do not entirely surround the trachea — since they do surround the majority of the trachea — the shechita is valid. This supports Tosafot's reading: the relevant measure for the lower rings is whether the majority of the trachea is encircled — and since it is, shechita there is valid, provided the cut achieves the majority of the trachea.

The Baraita also notes: hagrama is still a disqualifying psul. This means that even according to those who permit shechita in the lower rings, if the knife moves outside the valid zone during shechita, it remains disqualified.

### Chanina Testimony

Rabbi Chanina ben Antignos testified that hagrama is valid. This appears strikingly absolute. The resolution is that Rabbi Chanina ben Antignos holds a different definition of where the *makom hashechita* ends. He believes the valid zone extends higher than the standard position, such that what others would call hagrama — moving outside their defined upper boundary — falls within the valid zone as defined by Rabbi Chanina ben Antignos. He does maintain the psul of hagrama, but applies it at a different, higher location. Thus his testimony is not as absolute as it sounds; it represents a substantive difference in defining the upper limit of the valid shechita zone.
...
> **Hebrew/Aramaic:** כִּי סְלֵיק רַבִּי זֵירָא, אֲכַל מוּגְרֶמֶת דְּרַב וּשְׁמוּאֵל. אָמְרִי לֵיהּ: לָאו מֵאַתְרֵיהּ דְּרַב וּשְׁמוּאֵל אַתְּ? אֲמַר לְהוּ: מַאן אַמְרַהּ? יוֹסֵף בַּר חִיָּיא! יוֹסֵף בַּר חִיָּיא מִכּוּלֵּי עָלְמָא גְּמִיר.
>
> **Translation:** **When Rabbi Zeira ascended** from Babylonia to Eretz Yisrael, **he ate** meat from an animal during whose slaughter the knife was **diverted** from the place of slaughter, with regard to **which Rav and Shmuel** ruled that the slaughter is not valid, and in Eretz Yisrael the ruling was that the slaughter is valid. The Torah scholars in Eretz Yisrael **said to** Rabbi Zeira: **Aren't you from** Babylonia, **the place where Rav and Shmuel** are the halakhic authorities? You should follow their ruling. Rabbi Zeira **said to them: Who said** this *halakha* citing Rav and Shmuel? It was **Yosef bar Ḥiyya,** referring to Rav Yosef. **Yosef bar Ḥiyya learns from everyone,** even from students of Rav and Shmuel who misquote their statements.

When Rabbi Zeira made aliyah to Eretz Yisrael, he ate meat from an animal whose shechita would have been considered *mugremet* — and therefore invalid — according to the ruling of Rav and Shmuel. The practice in Eretz Yisrael was not to treat such shechita as invalid, and Rabbi Zeira accordingly ate it there without concern.

### Zeira Doubts Report

The people of Eretz Yisrael challenged him: was he not from the community of Rav and Shmuel? How could he eat this meat? Rabbi Zeira replied: who actually said that Rav and Shmuel took this position? The tradition had been reported by Yosef bar Chiya — that is, Rav Yosef — but Rabbi Zeira questioned whether Rav Yosef had really received this directly from Rav and Shmuel, implying that he may have simply heard it circulating and not from a direct transmission. Rabbi Zeira's implication was that he had never been fully persuaded that Rav and Shmuel actually said this, and therefore had never adopted it as a firm ruling — which would mean he may not have been strictly following this position even when he was in Bavel.

### Yosef Defends Source

> **Hebrew/Aramaic:** שְׁמַע רַב יוֹסֵף, אִיקְּפַד, אֲמַר: אֲנָא מִכּוּלֵּי עָלְמָא גְּמִירְנָא? אֲנָא מֵרַב יְהוּדָה גְּמִירְנָא, דַּאֲפִילּוּ סְפֵיקֵי דְּגַבְרֵי גָּרֵיס. דְּאָמַר רַב יְהוּדָה: אָמַר רַבִּי יִרְמְיָה בַּר אַבָּא, סָפֵק מִשְּׁמֵיהּ דְּרַב, סָפֵק מִשְּׁמֵיהּ דִּשְׁמוּאֵל: שְׁלֹשָׁה מַתִּירִין אֶת הַבְּכוֹר בִּמְקוֹם שֶׁאֵין מוּמְחֶה.
>
> **Translation:** **Rav Yosef heard** the comment of Rabbi Zeira and **was angry. He said:** Do **I learn from everyone? I learn from Rav Yehuda,** who is so meticulous in citing the statements of Rav and Shmuel **that he cites even uncertainties** with regard to attribution of statements **to the men** who said them. **As Rav Yehuda says** that **Rabbi Yirmeya bar Abba says,** and it is **uncertain** whether it is **in the name of Rav** and **uncertain** whether it is **in the name of Shmuel:** A tribunal of **three permits** slaughter of a blemished **firstborn** animal outside of the Temple **in a place where there is no expert** Sage to consult.

Rav Yosef heard that his transmission was being questioned and was deeply offended: did he receive his traditions from people on the street? He declared: he received this directly from Rav Yehuda, who was himself a student of Rav and Shmuel. Furthermore, Rav Yehuda was so precise in his traditions that even when he had a doubt as to which of his teachers had said something, he recorded that doubt explicitly, as evidenced by the formula: Rav Yehuda said in the name of Rabbi Yirmiya bar Abba — possibly in the name of Rav and possibly in the name of Shmuel. The very fact that Rav Yehuda would record such uncertainty demonstrates the meticulousness of his transmission, and therefore to suggest that his report of Rav and Shmuel's position was unreliable was deeply insulting.

### Bechor Blemish Ruling

The reason this chain of tradition is cited at all is parenthetical: it was Rav Yehuda's practice to record exactly what he heard and from whom, and the example cited — is incidental to establishing that practice. The ruling itself is that if there is no qualified expert available to examine a blemish on a bechor, three ordinary people may constitute a beit din to rule on the matter, even without the specialized expertise normally required.
...
> **Hebrew/Aramaic:** וְרַבִּי זֵירָא, לֵית לֵיהּ נוֹתְנִין עָלָיו חוּמְרֵי הַמָּקוֹם שֶׁיָּצָא מִשָּׁם וְחוּמְרֵי הַמָּקוֹם שֶׁהָלַךְ לְשָׁם?
>
> **Translation:** The Gemara asks: **And does Rabbi Zeira not accept** the principle that when a person travels from place to place, the Sages **impose upon him the stringencies of the place from which he emerged and the stringencies of the place to which he went?**

Having established that Rav and Shmuel did in fact rule that mugremet shechita is invalid, the Gemara addresses why Rabbi Zeira felt free to eat such meat in Eretz Yisrael. The general principle is that when traveling, one must observe the stringencies of the place one left — and the stringencies of the place one has arrived. If Rabbi Zeira had followed the ruling of Rav and Shmuel in Bavel, why did he not maintain that stringency in Eretz Yisrael?

### Abaye's Distinction

> **Hebrew/Aramaic:** אָמַר אַבָּיֵי: הָנֵי מִילֵּי מִבָּבֶל לְבָבֶל, וּמֵאֶרֶץ יִשְׂרָאֵל לְאֶרֶץ יִשְׂרָאֵל, אִי נָמֵי מֵאֶרֶץ יִשְׂרָאֵל לְבָבֶל, אֲבָל מִבָּבֶל לְאֶרֶץ יִשְׂרָאֵל, כֵּיוָן דַּאֲנַן כַּיְיפִינַן לְהוּ – עָבְדִינַן כְּוָותַיְיהוּ.
>
> **Translation:** **Abaye said: That statement** applies when one travels **from** one place in **Babylonia to** another place in **Babylonia, or from** one place in **Eretz Yisrael to** another place in **Eretz Yisrael,** or **alternatively,** when one descends **from Eretz Yisrael to Babylonia. But** when one ascends **from Babylonia to Eretz Yisrael,** this principle does not apply. **Since we,** the residents of Babylonia, **are subordinate to them** in terms of *halakha*, **we act in accordance with their** custom.

Abaye answers that the rule of following the stringencies of both one's place of origin and one's destination applies only to travel within the same country — from one part of Bavel to another, or from one part of Eretz Yisrael to another — or alternatively even when traveling from Eretz Yisrael to Bavel.

### Bavel to Israel

However, when traveling from Bavel to Eretz Yisrael, a different principle applies: since we, the Babylonians, are subservient to them, when we are in Eretz Yisrael we follow their practices entirely. This is a remarkable statement to appear in the Bavli: Bavel acknowledges that Eretz Yisrael constitutes the ultimate authority, and when a Babylonian is in Eretz Yisrael he does not retain his Babylonian practices but fully adopts those of Eretz Yisrael.

### Ashi's Condition

> **Hebrew/Aramaic:** רַב אָשֵׁי אָמַר: אֲפִילּוּ תֵּימָא מִבָּבֶל לְאֶרֶץ יִשְׂרָאֵל, הָנֵי מִילֵּי הֵיכָא דְּדַעְתּוֹ לַחֲזוֹר, רַבִּי זֵירָא אֵין דַּעְתּוֹ לַחֲזוֹר הֲוָה.
>
> **Translation:** **Rav Ashi said: Even** if **you say** that when one travels **from Babylonia to Eretz Yisrael,** he is required to act stringently in accordance with the custom of the place from which he emerged, **that statement** applies only in a case **where his intent is to return. Rabbi Zeira was not** one **whose intent was to return.** Therefore, he was not obligated to observe the Babylonian stringencies.

Rav Ashi qualifies this ruling: even the principle that one retains the practices of one's place of origin applies only where the person intends to return. If one plans to return to Bavel, one retains Babylonian practices even while in Eretz Yisrael. But if one does not intend to return, one fully adopts the practices of wherever one has gone.

### Zeira's Permanent Move

In the case of Rabbi Zeira, he did not intend to return to Bavel. Rabbi Zeira made aliyah permanently and settled in Eretz Yisrael. Accordingly, even on Rav Ashi's more qualified formulation, Rabbi Zeira was fully entitled to adopt the practices of Eretz Yisrael and to eat the mugremet meat without concern for the ruling of Rav and Shmuel.
...
> **Hebrew/Aramaic:** אֲמַר לֵיהּ אַבָּיֵי לְרַב יוֹסֵף: וְהָא רַבָּנַן דַּאֲתוֹ מִמָּחוֹזָא אָמְרִי, אָמַר רַבִּי זֵירָא מִשְּׁמֵיהּ דְּרַב נַחְמָן: מוּגְרֶמֶת כְּשֵׁרָה! אֲמַר לֵיהּ: נַהֲרָא נַהֲרָא וּפְשָׁטֵיהּ.
>
> **Translation:** **Abaye said to Rav Yosef: But didn't the Sages who came from Meḥoza say** that **Rabbi Zeira says in the name of Rav Naḥman:** In a case where the knife **is diverted** from the place of slaughter above the ring, the slaughter is **valid?** Rav Yosef **said to him: Each river and its** unique **course,** i.e., each place follows its custom, and in Meḥoza the custom was not in accordance with the opinion of Rav and Shmuel.

Abaye reports to Rav Yosef that the rabbis who came from Mechuza — a Jewish community in Bavel — say in the name of Rav Zeira, citing Rav Nachman, that mugremet shechita is kosher. This is striking, because it means that even within Bavel itself, in Mechuza, the practice was to permit what Rav and Shmuel had ruled impermissible. The question thus arises not only as a dispute between Bavel and Eretz Yisrael, but as a disagreement among communities within Bavel itself.

### Nahara Nahara

Rav Yosef responds with the celebrated phrase: every river and its tributaries. This phrase encapsulates a fundamental principle of halachic pluralism.
