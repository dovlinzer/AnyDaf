...
The daf begins after the *mishnah* on 23b, with the *gemara* picking up approximately two lines before the text widens on the page. The *mishnah* addressed the case of a man who married two women without knowing which one he had married: before his death he must give a *get* to each, and after his death *chalitzah* is performed with each. The *mishnah* then extends the discussion to scenarios involving two brothers or two separate men in parallel situations. The *gemara* now proceeds to analyze the underlying halachic assumptions of this *mishnah*.

### Two Sisters Scenario
...
> **Hebrew/Aramaic:** גְּמָ׳ שְׁמַע מִינַּהּ: קִדּוּשִׁין שֶׁאֵין מְסוּרִין לְבִיאָה — הָווּ קִדּוּשִׁין!
>
...
> **Hebrew/Aramaic:** הָכָא בְּמַאי עָסְקִינַן — כְּשֶׁהוּכְּרוּ וּלְבַסּוֹף נִתְעָרְבוּ. דַּיְקָא נָמֵי, דְּקָתָנֵי: "וְאֵינוֹ יוֹדֵעַ", וְלָא קָתָנֵי: "וְאֵינוֹ יָדוּעַ". שְׁמַע מִינַּהּ.
>
...
Rashi's explanation of how the *kiddushin* could be indeterminate from the very outset is as follows. He writes: *she'ein sofam lavo lidei biah* — at the moment of *kiddushin* it was never possible for relations to follow. The scenario Rashi envisions is one in which the man declared *harei achas mikem mekudeshet li* — "one of you is betrothed to me" — without specifying which sister. Both sisters had appointed a single agent to receive the *kiddushin* on their behalf, and the man gave the money to that agent without designating which sister he intended. As a result, the betrothal was indeterminate from its very inception, and since neither woman could be identified as his wife, relations with either would always have been forbidden as potentially intimacy with one's wife's sister.
...
One might press further: in the case of an *ervah* — a woman with whom relations are biblically forbidden as *arayot* — the *kiddushin* is likewise not binding. Why, then, should the two-sisters case, where relations are also forbidden, lead to a different conclusion? The distinction, as noted above and addressed explicitly by Tosafot, is that the *kiddushin* in the two-sisters case is itself the source of the problem. The act of betrothal is what creates the *issur*, not a pre-existing prohibition.

### Tosafot's Distinction

Tosafot formulates this clearly: *kiddushin she'einam re'uyim le'biah peirush she'al yedei kiddushin kamafsida biviah* — the category of *kiddushin* that cannot lead to relations refers specifically to a case where the *kiddushin* itself destroys the possibility of relations. By contrast, in cases of *chayavei lavin* or *chayavei aseh* — such as a *kohen* marrying a *gerushah*, or a *mamzer*, or a *petzu'a daka* — the prohibition on relations does not arise from the *kiddushin*. Indeed, in a somewhat ironic framing, those are considered *kiddushin ha-re'uyim le'biah* — betrothal that is in some sense oriented toward relations — because the *kiddushin* itself does not generate the impossibility.

### Gemara's Resolution

> **Hebrew/Aramaic:** מַאי קָא מַשְׁמַע לַן? סֵיפָא אִיצְטְרִיכָא לֵיהּ: מֵת וְלוֹ אָח אֶחָד — חוֹלֵץ לִשְׁתֵּיהֶן, הָיוּ לוֹ שְׁנַיִם — אֶחָד חוֹלֵץ וְאֶחָד מְיַיבֵּם. דַּוְקָא מִיחְלָץ וַהֲדַר יַבּוֹמֵי, אֲבָל יַבּוֹמֵי בְּרֵישָׁא — לָא, דְּקָא פָּגַע בַּאֲחוֹת זְקוּקָתוֹ.
>
...
The *gemara* resolves its initial inference by reframing the *mishnah*'s case: *hacha bemai askinan keshe-hukru basof nit'arvu* — we are dealing here with a situation where the identities were originally known and then subsequently became confused. The man did intend a specific woman at the moment of betrothal, the *kiddushin* was therefore unambiguously valid, and only afterwards did confusion arise as to which sister he had married. Accordingly, no proof can be derived from this *mishnah* regarding *kiddushin she'einam re'uyim le'biah*, since the *mishnah* is not addressing that case at all.
...
The *gemara* notes that this reading is also supported by the precise language of the *mishnah* itself. The *mishnah* uses the formulation *ve'eino yodeia* — "and he does not know" — rather than *ve'eino yadu'a*, which would mean "and it is not known." The active construction indicates that *he* does not know, but the information exists and was once known. This linguistic precision confirms that the scenario is one of subsequent confusion, not original indeterminacy.

### Seifa's Role

Given that the *kiddushin* is clearly valid and this point requires no special derivation, the *gemara* asks: what is the *chiddush* of the *mishnah*? The answer is *seifa itztricha lei* — the *mishnah* is needed for the practical rulings found in its concluding portion, which spell out how *chalitzah* and *yibum* are to be conducted once the husband dies.

### One Brother Case

If the husband died and there is one surviving brother, he performs *chalitzah* with both women, since it is unknown which one creates the obligation.

### Two Brothers Case

If there were two brothers, one performs *chalitzah* and the other performs *yibum*. However, this must be done in a specific order: *davka mechaleitz ve'hadar yabumei* — the *chalitzah* must precede the *yibum*. The reason is that if the brother were to perform *yibum* first — say, with one of the sisters — and that sister turns out not to be the one to whom he is *zakuk*, then he would have engaged in relations with the sister of the woman to whom he is *zakuk*, violating the prohibition of *achot zikukato*.

To illustrate: suppose the deceased was married to either Rachel or Leah, and the surviving brothers are Shimon and Levi. If Shimon performs *chalitzah* with Rachel, and it turns out Rachel was indeed the obligated *yevamah*, Levi can then perform *yibum* with Leah without any concern. If, on the other hand, Leah was the obligated *yevamah*, then Shimon's *chalitzah* was technically superfluous but harmless, and Shimon himself has fulfilled the *mitzvah* of *yibum* with Leah. In either scenario, proceeding in the order of *chalitzah* first ensures that no violation occurs. But if Levi were to begin with *yibum* to Leah, and Rachel was in fact the obligated woman, then Levi would have had relations with *achot zikukato* — the sister of the woman to whom he bears a *zikah*.
...
The *mishnah* then presents a more complex scenario involving two unrelated men — each of whom married one of two sisters without knowing which — who both die. One man has a single surviving brother and the other has two surviving brothers.
...
When both husbands die — one leaving one brother and one leaving two brothers — the single brother performs *chalitzah* with both women and steps aside. This allows the two brothers of the other husband to proceed: one performs *chalitzah* and the other performs *yibum*, just as in the earlier case. The *gemara* then asks whether there is any novelty in stating this, given that the earlier portion of the *mishnah* already established the same principle. The answer is that without this ruling one might have feared a precedent — perhaps one of the parties would reason that since two brothers in the other family can do *chalitzah* and then *yibum*, perhaps the single brother could also do *chalitzah* with one woman and *yibum* with the other. The *mishnah* therefore states explicitly that this is not permitted.

### Why No Yibum First

Furthermore, the reason the single brother cannot perform *yibum* at all — even after *chalitzah* with one of the women — is that if he were to do so, it could constitute relations with *achot chalutzato*. And before he has performed *chalitzah* and exited the picture, if one of the two brothers of the other husband were to perform *yibum*, that brother might be performing *yibum* with a *yevamah lashuk* — a woman who is awaiting resolution with the single brother — since the *zikah* of the single brother has not yet been dissolved. Thus, the single brother must perform *chalitzah* with both women first, clearing the way for the remaining two brothers to proceed with one performing *chalitzah* and the other performing *yibum*.
...
The final scenario of this section involves two unrelated men, each with two surviving brothers, both of whom had married two sisters without knowing which sister each had married.

### Solution Strategy

The *mishnah* prescribes a specific solution: each pair of brothers coordinates so that one member of each pair performs *chalitzah* with one woman while the other performs *yibum* with the other. Specifically, the first brother performs *chalitzah* with Leah and the second brother of the other pair performs *chalitzah* with Rachel; then the respective partners in each pair perform *yibum* with the other woman.
...
> **Hebrew/Aramaic:** שְׁנַיִם שֶׁקִּדְּשׁוּ שְׁתֵּי אֲחָיוֹת וְכוּ׳. שְׁמַע מִינַּהּ: קִדּוּשִׁין שֶׁאֵין מְסוּרִין לְבִיאָה — הָווּ קִדּוּשִׁין! הָכָא נָמֵי, כְּשֶׁהוּכְּרוּ וּלְבַסּוֹף נִתְעָרְבוּ. דַּיְקָא נָמֵי, דְּקָתָנֵי: "וְאֵין יוֹדֵעַ", וְלָא קָתָנֵי "וְאֵין יָדוּעַ". שְׁמַע מִינַּהּ.
>
...
> **Hebrew/Aramaic:** מַאי שְׁנָא מֵהָא דִּתְנַן: אַרְבָּעָה אַחִין, שְׁנַיִם מֵהֶן נְשׂוּאִין שְׁתֵּי אֲחָיוֹת, וּמֵתוּ הַנְּשׂוּאִין אֶת הָאֲחָיוֹת — הֲרֵי אֵלּוּ חוֹלְצוֹת וְלֹא מִתְיַיבְּמוֹת?
>
...
When Levi then performs *chalitzah* with Rachel, the *zikah* to Rachel is dissolved, and she is no longer *zikukato*. But this dissolution does not undo the original *issur*: at the moment that Rachel became *achot zikukato* she simultaneously became *eshet ach* without *mitzvat yibum*, and that status of *ervah* does not disappear merely because the *zikah* has now been resolved. Rachel remains forbidden. By the same logic, Leah is also *achot zikukato* from the moment of Reuven's death — she is forbidden as the sister of the woman to whom Levi is *zakuk* via Reuven's *zikah*. Even after *chalitzah* is performed with Rachel, Leah retains her status as *ervah* because she too, at the moment of death, was a *yevamah* with no *mitzvah* of *yibum*, making her an *eshet ach* with *ervah* status. That status endures.
...
> **Hebrew/Aramaic:** הָתָם, אִי לְמַאן דְּאָמַר יֵשׁ זִיקָה — יֵשׁ זִיקָה, וְאִי לְמַאן דְּאָמַר אָסוּר לְבַטֵּל מִצְוַת יְבָמִין — אָסוּר לְבַטֵּל מִצְוַת יְבָמִין. הָכָא — כׇּל חַד וְחַד אֵימוֹר דִּידֵיהּ קָא מִתְרַמְיָא לֵיהּ.
>
...
> **Hebrew/Aramaic:** קָדְמוּ וְכָנְסוּ אֵין מוֹצִיאִין כּוּ׳. תָּנֵי שֵׁילָא: וַאֲפִילּוּ שְׁנֵיהֶם כֹּהֲנִים. מַאי טַעְמָא — חֲלוּצָה דְּרַבָּנַן הִיא, וְסָפֵק חֲלוּצָה לָא גְּזַרוּ בְּהוּ רַבָּנַן.
>
...
> **Hebrew/Aramaic:** וַחֲלוּצָה דְּרַבָּנַן הִיא? וְהָתַנְיָא: "גְּרוּשָׁה", אֵין לִי אֶלָּא גְּרוּשָׁה, חֲלוּצָה מִנַּיִן? תַּלְמוּד לוֹמַר: "וְאִשָּׁה"! מִדְּרַבָּנַן הוּא, וּקְרָא אַסְמַכְתָּא בְּעָלְמָא הוּא.
>
...
> **Hebrew/Aramaic:** קָדְמוּ וְכָנְסוּ — אֵין מוֹצִיאִין מִיָּדָם.
>
> **Translation:** If **they married** their wives **before** consulting the court, the court **does not remove them** from the marriage.
...
> **Hebrew/Aramaic:** מַתְנִי׳ מִצְוָה בַּגָּדוֹל לְיַיבֵּם, וְאִם קָדַם הַקָּטָן — זָכָה.
>
...
> **Hebrew/Aramaic:** גְּמָ׳ תָּנוּ רַבָּנַן: "וְהָיָה הַבְּכוֹר" — מִיכָּן שֶׁמִּצְוָה בַּגָּדוֹל לְיַיבֵּם. "אֲשֶׁר תֵּלֵד" — פְּרָט לְאַיְלוֹנִית, שֶׁאֵין יוֹלֶדֶת. "יָקוּם עַל שֵׁם אָחִיו" — לְנַחֲלָה.
>
...
> **Hebrew/Aramaic:** אַתָּה אוֹמֵר לְנַחֲלָה, אוֹ אֵינוֹ אֶלָּא לְשֵׁם: יוֹסֵף — קוֹרִין אוֹתוֹ יוֹסֵף, יוֹחָנָן — קוֹרִין אוֹתוֹ יוֹחָנָן. נֶאֱמַר כָּאן "יָקוּם עַל שֵׁם אָחִיו", וְנֶאֱמַר לְהַלָּן: "עַל שֵׁם אֲחֵיהֶם יִקָּרְאוּ בְּנַחֲלָתָם", מָה שֵׁם הָאָמוּר לְהַלָּן — נַחֲלָה, אַף שֵׁם הָאָמוּר כָּאן — לְנַחֲלָה.
>
...
> **Hebrew/Aramaic:** "וְלֹא יִמָּחֶה שְׁמוֹ" — פְּרָט לְסָרִיס שֶׁשְּׁמוֹ מָחוּי.
>
...
> **Hebrew/Aramaic:** אָמַר רָבָא: אַף עַל גַּב דִּבְכׇל הַתּוֹרָה כּוּלָּהּ אֵין מִקְרָא יוֹצֵא מִידֵי פְשׁוּטוֹ — הָכָא אֲתַאי גְּזֵרָה שָׁוָה אַפֵּיקְתֵּיהּ מִפְּשָׁטֵיהּ לִגְמָרֵי.
>
...
> **Hebrew/Aramaic:** וְאִי לָאו גְּזֵרָה שָׁוָה, הֲוָה אָמֵינָא "שֵׁם" — שֵׁם מַמָּשׁ? לְמַאן קָמַזְהַר רַחֲמָנָא? לְיָבָם — "יָקוּם עַל שֵׁם אָחִיךָ" מִיבְּעֵי לֵיהּ! אִי לְבֵי דִינָא — "יָקוּם עַל שֵׁם אֲחִי אָבִיו" מִיבְּעֵי לֵיהּ!
>
...
> **Hebrew/Aramaic:** וְדִלְמָא הָכִי קָאָמַר לְהוּ רַחֲמָנָא לְבֵית דִּין: אֱמַרוּ לֵיהּ לְיָבָם "יָקוּם עַל שֵׁם אָחִיו". אֶלָּא אֲתַאי גְּזֵרָה שָׁוָה אַפֵּיקְתֵּיהּ לִגְמָרֵי.
>
...
> **Hebrew/Aramaic:** הַשְׁתָּא דְּאָמְרַתְּ קְרָא בְּגָדוֹל כְּתִיב, אֵימָא: בְּכוֹר — לְיַיבֵּם, פָּשׁוּט — לָא לְיַיבֵּם!
>
...
> **Hebrew/Aramaic:** וְאֵימָא: כִּי לֵיכָּא בְּכוֹר, קְדַם קָטָן — זְכָה. וְאִי אִיכָּא בְּכוֹר, קְדַם קָטָן — לָא זְכָה! אָמַר קְרָא: "כִּי יֵשְׁבוּ אַחִים יַחְדָּו" — הוּקְּשָׁה יְשִׁיבַת אַחִים זֶה לָזֶה.
>
...
> **Hebrew/Aramaic:** אַלְּמָה תָּנֵי אַבָּיֵי קַשִּׁישָׁא: מִצְוָה בַּגָּדוֹל לְיַיבֵּם, לֹא רָצָה — הוֹלְכִים אֵצֶל אָחִיו הַקָּטָן, לֹא רָצָה — חוֹזְרִין אֵצֶל גָּדוֹל!
>
> **Translation:** **Why did Abaye the Elder teach: It is a mitzva for the eldest** of the brothers **to consummate the levirate marriage? If** the eldest **did not wish** to do so, then the court **goes to his younger brother.** If **he** also **did not wish** to do so, the court **returns** again **to the eldest.** This implies that the eldest, even if he is not the firstborn, has a greater mitzva than the younger brothers.
...
> **Hebrew/Aramaic:** כִּבְכוֹר: מָה בְּכוֹר — בְּכוֹרָתוֹ גָּרְמָה לוֹ, אַף גָּדוֹל — גְּדוּלָּתוֹ גָּרְמָה לוֹ.
>
...
Abbaye the elder (*Abbaye kishisha*) teaches: *mitzvah be-gadol le-yabeim* — it is a *mitzvah* for the *gadol*, the eldest surviving brother, to perform *yibum*.
...
> **Hebrew/Aramaic:** וְאֵימָא: כִּי מְיַיבֵּם בְּכוֹר — לִישְׁקוֹל נַחֲלָה, כִּי מְיַיבֵּם פָּשׁוּט — לָא לִישְׁקוֹל נַחֲלָה. אָמַר קְרָא: "יָקוּם עַל שֵׁם אָחִיו", וַהֲרֵי קָם.
>
...
With the principle of *gadol* preference established, the *gemara* asks whether that preference negates the capacity of younger brothers to act.

### Bechor Block Theory

Specifically: perhaps when a *bechor* or *gadol* is present, the younger brother is entirely blocked from performing *yibum*, and his act, if performed, is invalid.
...
If all the brothers refuse — if each in turn declines to perform either *yibum* or *chalitzah* — the obligation returns to the *gadol*, and *beit din* demands that he perform one or the other. The *gadol* bears ultimate responsibility that the *mitzvah* is not left entirely unfulfilled.

### Ke-Bechor Derash

The verse uses the term *bechor* — firstborn — but the *gemara* understands it to mean *ke-bechor*: in the manner of a firstborn. Just as firstborn status places one at the head of the line in matters of inheritance, so too does seniority in age place a brother at the head of the line for the *mitzvah* of *yibum*. The principle of priority is abstracted from *bechor* status and applied to the concept of *gadol*.

## Inheritance Rights

### Inheritance Exclusivity

> **Hebrew/Aramaic:** וְאֵימָא: כִּי אִיכָּא בְּכוֹר — לֶיהְדַּר אַגָּדוֹל. כִּי לֵיכָּא בְּכוֹר — אֵין חוֹזְרִין אֵצֶל גָּדוֹל!
>
> **Translation:** The Gemara challenges the *halakha* again: **Then say: When there is a firstborn, let** the mitzva **return to the eldest** brother if the other brothers refuse to perform levirate marriage. But **when there is no firstborn,** the court **does not return to the eldest,** as the mitzva primarily applies specifically to the firstborn, and if there is no firstborn, none of the brothers take precedence.

The *gemara* raises yet another possible limitation: perhaps the *yavam*'s inheritance of the dead brother's portion — *yakum al shem achiv le-nachala* — applies only when the performing *yavam* is the *bechor*. The *bechor* already has enhanced inheritance rights; perhaps the entitlement to the dead brother's portion through *yibum* is his alone.

### Universal Application

The *gemara* rejects this. *Yakum al shem achiv* refers to whoever performs *yibum* — he assumes the dead brother's place and thereby inherits his portion. There is no limitation to the *bechor*. Whoever steps forward and fulfills the *mitzvah* receives the dead brother's estate.

## Bechor Status Limits

### Terminology Question

> **Hebrew/Aramaic:** וְאֶלָּא "בְּכוֹר" דְּקַרְיֵיהּ רַחֲמָנָא,
>
...
If the verse's mention of *bechor* does not limit the *mitzvah* to firstborns, does not restrict the inheritance to firstborns, and does not require the presence of a firstborn — what purpose does the term *bechor* serve in this context?
...
Concretely, the *yavam* who performs *yibum* acquires what the dead brother already owned, but does not acquire what was merely coming to the dead brother at some future point — including, according to some authorities, the dead brother's prospective share of the father's estate if the father has not yet died.

## Inheritance Examples

### Property Scenario

A concrete illustration: suppose the father has one million in actual assets and a further hundred thousand in outstanding loans owed to him. Reuven, one of his sons, dies, and Shimon performs *yibum*.

### Actual Possession

Shimon, by virtue of *yibum*, steps into Reuven's position with respect to the father's estate. When the father dies, the one million in actual assets is divided as if there are three sons — Reuven, Shimon, and Levi — with Shimon receiving Reuven's share of approximately 333,000, in addition to his own share. This reflects the inheritance of *muchzak* property.

### Prospective Property

The hundred thousand in outstanding loans, however, is *ra'uy* — it was not yet in the father's possession. When that money is eventually collected, it is divided equally among the living heirs, with Shimon having no enhanced claim to Reuven's portion thereof. Reuven's prospective entitlement to a share of the recovered loans does not pass to Shimon through *yibum*.

### Gra's Girsa

The Gra, citing Rabbeinu Tam, understands the passage differently. According to Rabbeinu Tam, the operative case is not the father's outstanding loans but rather Reuven's own existing property at the time of his death. If Reuven already owned a house worth five hundred thousand, and Shimon performs *yibum*, Shimon acquires Reuven's house outright — that is *muchzak*. What Shimon does *not* acquire is Reuven's prospective share of the father's inheritance if the father is still alive at the time of *yibum*. That prospective inheritance is *ra'uy*, and the verse's equation of the *yavam* with a *bechor* means that he, like a *bechor*, does not receive *ra'uy ke-muchzak*. When the father eventually dies, the estate is divided equally among all living heirs, without Shimon receiving any enhanced claim based on his *yibum* of Reuven.

## Five Brothers Debt Case

### Debt Collection

The *mishnah* on 24a presents a related case: five brothers who collect a debt that was owed to their father. The question is whether the *bechor* among them receives a double portion of the recovered debt.

### No Double Portion

The *mishnah* rules that the *bechor* does not receive a double portion.

### Rau'i Status

The reason is that the debt is *ra'uy* — prospective — rather than *muchzak* — actually in the father's possession. The money was in the possession of the borrower during the father's lifetime, not in the father's possession. It therefore falls into the category of property to which the *bechor*'s double portion does not apply.

### Land Collection

A further question arises: if the brothers collected land from the debtor in lieu of the monetary debt, does the status change? The *mishnah* addresses this as well, with the position that even land received in payment for the debt retains its *ra'uy* character, since it stands in the place of the debt.

### Machloket on Land

There is however a *machloket* in the *gemara* on this point. Some hold that once land has been physically collected and taken into possession, it assumes the status of *muchzak*, and the *bechor* would then receive a double portion in the land. The definitive ruling on this question is to be examined in the *gemara* on the following *amud*.