...
The *gemara* now asks, *umai shena mehadi tnan* — how is this different from what we learned in the *mishnah* regarding four brothers? The comparison is worth pausing over. One might think the two scenarios are parallel: in both, two pairs of brothers are entangled with two women who are sisters. But the *gemara* recognizes that the certain-marriage case is in an important sense easier. There is no doubt about who was married to whom. Reuven was married to Rachel and Shimon was married to Leah — that much is known. The question is simply what Levi and Yehuda may do once Reuven and Shimon have died. The answer, as the *gemara* will develop, is that Levi cannot perform *yibum* with Rachel, because he is also *zakuk* to Leah, and performing *yibum* with Rachel would mean he is having relations with *achot zikukato*. One might then suggest: let Levi perform *chalitzah* with Rachel, removing her from the picture for Yehuda, and then proceed to perform *yibum* with Leah. The *gemara*'s response to why this does not suffice — why both women require *chalitzah* and neither may be taken in *yibum* — turns on a distinction between the certain case and the uncertain one, a distinction the *gemara* will explain in the section that follows.
...
It is worth clarifying precisely what is meant when we say the prohibition is *d'rabanan*. We do not mean that the *mitzvah* of *chalitzah* itself is rabbinic — we mean that the resulting status of *chalutza* as an *issur* for a *kohen* is rabbinic in nature. The *pasuk* prohibiting a *kohen* from marrying a *gerushah* does not explicitly mention a *chalutza*, and the derivation that extends the prohibition to her — reading *v'isha*, "and a woman," as encompassing anyone analogous to a *gerushah* — is treated by the Bavli as an *asmakhta b'alma*, a mere Scriptural support rather than a true biblical source. This is what allows for the leniency in the *safek* case: a doubt concerning a rabbinic prohibition is resolved permissively.
...
It is worth noting that the *gemara* derives this priority for the eldest brother from scripture — and that the derivation is, on its face, a surprising one. The plain sense of the verse *ve-haya ha-bechor asher teleid yakum al shem achiv ha-met* — the firstborn who will be born will be named after the dead brother — has nothing to do with which surviving brother performs the *yibum* at all. It speaks of the child who results from the union, not the man who initiates it. The *gemara* nonetheless reads *ve-haya ha-bechor* not as a description of the child who will be born, but as a directive concerning which brother acts: it is the *bechor*, the eldest, who performs the *yibum* — a reading the *gemara* reaches by separating *ve-haya ha-bechor* from what follows it and attaching it instead to the immediately preceding word *ve-yibma*. That the same verse then continues *asher teleid* — "who will be born" — leads the *gemara* to its next derivation, a question the *gemara* will address in the section that follows.
...
There is however a *machloket* in the *gemara* on this point. Some hold that once land has been physically collected and taken into possession, it assumes the status of *muchzak*, and the *bechor* would then receive a double portion in the land. The reasoning is that although the original debt was *ra'uy*, the act of collection transforms the asset into something the heirs now physically hold — and it is that physical possession, not the history of the asset, that determines the *bechor*'s entitlement. The definitive ruling on this question is to be examined in the *gemara* on the following *amud*.
