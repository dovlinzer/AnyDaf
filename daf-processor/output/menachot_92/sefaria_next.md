...
*Translation:* **And** the other **one said** that it is **derived** from a verbal analogy between the mention of **placing hands** in the passage detailing the general requirement to do so, and the mention of **placing hands** stated with regard to the **burnt offering of appearance** brought by an individual on the pilgrimage Festivals: Just as a blind person is exempt from making the pilgrimage to Jerusalem and bringing the offering (see *Ḥagiga* 2a), so too he is excluded from the requirement of placing hands.
