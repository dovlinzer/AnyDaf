...
*Translation:* The Gemara explains: **When** the mishna **teaches** the case of **an unslaughtered carcass,** it is a case where the animal **does not** assume that status and **imparts impurity while alive. But** the *tanna* **does not teach** the case of **an unslaughtered carcass** where the animal assumes that status and **imparts impurity while alive,** e.g., the cases of Ḥizkiyya and Rabbi Elazar.
