...
Underlying this preference is a point about what "knot" means in this halachic context. Rashi does not explicitly use the phrase "double knot," but his reasoning makes clear that the knot required for the *lulav* must qualify as a genuine, halachically recognized knot — specifically, the kind of knot whose very tying would raise questions on *Shabbos* and *Yom Tov*. This follows from the *gemara*'s assumption that according to Rabbi Yehuda there is no knot one could tie on *Yom Tov* that would simultaneously work for the *lulav*, which means any knot sufficient for the *lulav* would by definition be the sort of knot governed by the laws of *Shabbos* and *Yom Tov*. Since the halacha defines a knot for *Shabbos* and *Yom Tov* as a double knot rather than a bow, it follows that a bow alone would not meet the standard — leaving the double knot as the operative requirement for binding the *lulav*.
