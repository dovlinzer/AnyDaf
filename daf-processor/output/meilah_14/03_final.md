...
> **Hebrew/Aramaic:** אֵיתִיבֵיהּ רֵישׁ לָקִישׁ לְרַבִּי יוֹחָנָן: הַקֵּן שֶׁבְּרֹאשׁ הָאִילָן שֶׁל הֶקְדֵּשׁ – אֵין נֶהֱנִין וְאֵין מוֹעֲלִין. שֶׁבָּאֲשֵׁירָה יַתִּיז בְּקָנֶה.
...
> **Hebrew/Aramaic:** אֲמַר לֵיהּ: רַבִּי יַעֲקֹב לְרַבִּי יִרְמְיָה אֶפְרוֹחִים כָּאן וְכָאן – מוּתָּרִין. בֵּיצִים, כָּאן וְכָאן – אֲסוּרִין. אָמַר רַב אָשֵׁי: אִם אֶפְרוֹחִים צְרִיכִין לְאִמָּן – כְּבֵיצִים דָּמוּ.
> **Translation:** **Rabbi Ya’akov said to Rabbi Yirmeya:** With regard to **chicks** that can fly away and are not confined to this specific tree, both **here and there,** i.e., both in the case of a consecrated tree and in the case of a worshipped tree, it is **permitted** to derive benefit from them. But with regard to **eggs,** both **here and there,** it is **prohibited** to derive benefit from them, as they are dependent on the prohibited tree. **Rav Ashi** further **says: If** the **chicks** are young and still **need their mother** to survive they **are considered like eggs,** i.e., they have the same status as eggs and it is prohibited to derive benefit from them.
...
> **Hebrew/Aramaic:** גְּמָ׳ אָמַר שְׁמוּאֵל: בּוֹנִין בַּחוֹל וְאַחַר כָּךְ מַקְדִּישִׁין.
> **Translation:** GEMARA: **Shmuel says** that the method of construction in the Temple, for repairs or improvements, is as follows: One **builds** the structures in the Temple **with non-sacred** materials, **and afterward consecrates** those materials upon completion of the work.
...
> **Hebrew/Aramaic:** מֵיתִיבִי: מוֹתַר הַקְּטֹרֶת מָה הָיוּ עוֹשִׂין בּוֹ? הָיוּ מַפְרִישִׁין מִמֶּנָּה שְׂכַר הָאוּמָּנִין.
...
One also wants to understand why, in this mechanism, the materials used for construction must themselves be non-sanctified — *bonin bechol*, building with ordinary, non-*hekdesh* items. The reason parallels the logic governing the workers' payment. Just as one cannot transfer *kedusha* onto abstract labor, one equally cannot transfer *kedusha* onto the abstract improvement of an object that was already sanctified to begin with. If the wood or stone started out as *kadosh*, and workers then engraved it or built it into the structure, the physical object was *kadosh* the entire time — so what exactly would one be transferring the *kedusha* of the donated money onto? The improvement in value is nebulous, no more concrete than the labor itself. By contrast, if the raw materials begin as ordinary *chol* and are then improved through construction, one ends up with a stone now worth fifty *drachma* that is not itself *kadosh* — a concrete, physical object onto which the *kedusha* of the money can be cleanly transferred. This is why the requirement that materials be *chol* and the requirement that one wait until the work is complete are two sides of the same underlying principle: in both cases, one needs something physically concrete and non-sanctified, now improved in value, to serve as the vessel for the transfer.
...
> **Hebrew/Aramaic:** וְהָאָמַר שְׁמוּאֵל: הֶקְדֵּשׁ שָׁוֶה מָנֶה שֶׁחִילְּלוֹ עַל שָׁוֶה פְּרוּטָה – מְחוּלָּל! הָנֵי מִילֵּי דְּאִי עֲבַד, לְכַתְּחִלָּה – לָא.
> **Translation:** The Gemara raises a further difficulty: **But doesn’t Shmuel say** with regard to **consecrated** property **worth one hundred** dinars **that** if the Temple treasurer **redeemed it for** an object **worth** only **one *peruta*,** it is **redeemed,** despite the fact that the redemption was performed with an item that was not worth the full value of the consecrated property? The Gemara answers: **This statement** of Shmuel applies to a case **where one did** so, i.e., it applies only after the fact, but the Temple treasurer should **not** act in this manner ***ab initio*.**
...
> **Hebrew/Aramaic:** תְּנַן: הַגִּזְבָּרִין שֶׁלָּקְחוּ אֶת הָעֵצִים – מוֹעֲלִין בָּהֶן, וְאֵין מוֹעֲלִין לֹא בַּשִּׁיפּוּיי וְלֹא בַּנְּבִיָּיה.
...
> **Hebrew/Aramaic:** הַדְרָן עֲלָךְ וְלַד חַטָּאת
