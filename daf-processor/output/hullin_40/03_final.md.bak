...
This ruling carries a structural parallel to what was established earlier regarding the thoughts of an owner. Just as, according to Rabbi Eliezer, even a partial owner's disqualifying thoughts can invalidate a slaughter, so too here — even if one does not constitute the entirety of the *shochet*, being one of the participants is sufficient for one's intention to carry invalidating force. One might naturally ask what the ruling would be if the animal and knife belong to one of the parties, and the other participant — acting without the owner's consent — harbors idolatrous intent. The Gemara will address precisely this question in the course of the discussion ahead.
...
The distinction Abaye draws immediately raises a deeper question: why should it matter whether the offering is directed to the mountain itself versus the spirit of the mountain? If the act is one of *avodah zarah* either way, why would the mountain-case yield only *psulah* while the spirit-case yields full prohibition in *hana'ah*? The Gemara's answer rests on a principle established in *avodah zarah*: if a person worships a mountain, the mountain itself does not become forbidden in benefit. The practical stakes of any alternative ruling are plain — in an ancient world saturated with nature worship, if the actual earth could become forbidden through someone's act of veneration, the consequences for daily life would be unworkable. One cannot simply say the worshipper does not own the mountain, either; the point is more fundamental.
...
From this principle, the Gemara draws further distinctions. Something that is a natural, continuous part of the earth — a mountain, a hill, a river — cannot be made forbidden through worship. If, however, one worships a small worm, that worm *can* become forbidden, since it is not embedded in or constitutive of the earth in the same way. The sun, moon, and stars present a more complex case: one might argue they are analogous to mountains by virtue of being beyond human control and ownership, or one might argue otherwise. *tosafot* engages with this question. Setting aside that complication for the moment, the Gemara's working assumption is that celestial bodies are treated like mountains in this regard.
...
Rashi proposes a principled distinction. When the Gemara excludes a mountain from becoming forbidden, Rashi argues, what *halacha* is really saying is that it does not even recognize the mountain as a legitimate object of worship in any halachic sense. It is not that the mountain is an object of worship which happens to be exempt from the prohibition of *issur hana'ah*; rather, the mountain is not considered an object of worship at all. Something that is not a discrete entity — that is part of the undifferentiated earth, not susceptible to individual ownership or definition — cannot even be categorized halachically as an object of worship. Since it is not recognized as an object of worship, the animal offered to it is not recognized as an offering to an object of worship, and therefore it too does not become forbidden.
...
The underlying difficulty is that three legally distinct questions do not map onto each other in a coherent pattern. First: is the worshipper personally liable for *avodah zarah*? Here the answer is categorical — any act of worship directed toward anything other than God, whether mountain, sun, angel, or worm, renders one *chayav misa*. Second: does the object of worship itself become forbidden in *hana'ah*? Here, things attached to or constitutive of the earth do not become forbidden; animals also do not become forbidden; but implicitly, discrete manufactured objects do. Third: does the item offered to these various objects become forbidden? Here, offerings to mountains and the like do not become forbidden; offerings to animals do become forbidden; and offerings to the spirit or angel of the mountain become forbidden as well.

The three categories do not align neatly. Personal culpability is universal; the status of the object of worship and the status of the offering made to it follow independent rules that do not mirror each other. Rashi's distinction between the mountain as a non-object and the animal as a recognized-but-exempt object of worship represents one attempt to impose coherence, though *tosafot*'s challenge makes clear that full consistency remains elusive.
...
The logic of this distinction is as follows. The principle of *ein adam oser davar she'eino shelo* is in essence a statement about the limits of personal designation: you cannot unilaterally impose a halachic definition upon property that belongs to someone else. When one merely bows before another's animal, the act is entirely internal and declarative — it is a statement of intent that one has no authority to impose on another's possessions. But when one physically acts upon the object — cuts into it, changes it — one is demonstrating actual physical dominion over it. That physical control renders one's designating act meaningful. The designation is no longer merely a mental or verbal imposition on someone else's property; it is expressed through and realized in a physical transformation of the object itself.

It is worth noting that not every physical intervention on someone else's property works this way. If one were to take a friend's meat and a friend's milk and cook them together, the mixture becomes *basar b'chalav* regardless of ownership, because the forbidden status arises from a physical reality — the fact of their being cooked together — and ownership is irrelevant to the physical determination. Here, however, the situation is different: an animal with a cut neck is not forbidden by virtue of its physical state alone. The forbidden status depends on one's designation of it as an idolatrous offering. Ordinarily, that designation cannot be imposed on another's property; but when the designation is expressed through physical action that changes the object, it acquires sufficient force to overcome the ownership barrier.
...
> **Hebrew/Aramaic:** אָמַר רַב פָּפָּא: אִי לָאו דְּאָמַר רַב הוּנָא סִימָן אֶחָד, לָא הָוְיָא חַטָּאת תְּיוּבְתֵּיהּ.
>
...
## Rav Nachman's Absolute Position
...
Rav Huna introduces two distinct innovations. The first concerns the stage at which slaughter becomes an idolatrous offering: he holds that even the slightest initial cut — the very beginning of the *shechita* — is sufficient to render the animal an offering to *avodah zarah*, without waiting for the full *shechita* to be completed. The second concerns the scope of *ein adam oser davar she'eino shelo*: he holds that performing a physical act on someone else's animal is sufficient to allow one to redefine its status as an idolatrous offering, overriding the general rule that one cannot make another's property forbidden.
...
Despite their sharp disagreement regarding ordinary property, both positions converge on the case of a *korban*. Both Rav Huna and the three Amoraim agree that a *korban* can be made forbidden through an idolatrous act, and both agree that even minimal action suffices in that case. Their reasoning, however, differs entirely. Rav Huna reaches this conclusion because he holds that *ein adam oser davar she'eino shelo* is not absolute to begin with — one can make any object forbidden through action — and a *korban* is simply a case of someone else's property that he permits under his general rule. Rav Nachman, Rav Amram, and Rav Yitzchak, for whom the general rule is absolute, must argue that a *korban* is distinguishable from an ordinary friend's animal: the atonement-relationship makes it sufficiently *one's own* that the rule against forbidding another's property does not apply at all. The same ruling thus emerges from two entirely distinct conceptual frameworks, a reminder that halachic convergence does not always signal underlying agreement.