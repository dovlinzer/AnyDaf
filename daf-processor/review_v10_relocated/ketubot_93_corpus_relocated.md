...
What makes the result publishable — and what transforms it from an observation into a theorem — is Aumann's proof that for any number of claimants and any estate size, there is always exactly one and uniquely one division that satisfies the pairwise *shnayim ochzim* rule for every possible pair simultaneously. It is something like a Sudoku: there are constraints, and those constraints determine a unique solution. The *mishna*'s three cases, which appeared to follow unrelated rules, in fact all reflect this single underlying principle. The rule itself, it should be noted, is not the only conceivable one; as Aumann observes at the outset of his paper, one could instead divide everything equally until each claimant is fully satisfied — which privileges the smaller claimant — or distribute proportionally throughout. The principle of *shnayim ochzim* is a coherent and defensible rule, but it is a rule, not an inevitability. What the *mishna* encodes is a specific commitment to the logic that what one party concedes should not be treated as disputed — and that commitment, applied pairwise to every combination of claimants, determines the answer uniquely. One might add: it is striking that this explanation was apparently lost, that the *rishonim* could not reconstruct it, and that Tosafot itself acknowledges — in its laconic way — *lo ispareish shapir ta'ama d'hanei milta*: the rationale for these matters has not been well explained.
...
> **Hebrew/Aramaic:** גְּמָ׳ שֶׁל מָנֶה נוֹטֶלֶת חֲמִשִּׁים? תְּלָתִין וּתְלָתָא וְתִילְתָּא הוּא דְּאִית לַהּ!
...
> **Hebrew/Aramaic:** אָמַר שְׁמוּאֵל: בְּכוֹתֶבֶת בַּעֲלַת מָאתַיִם לְבַעֲלַת מָנֶה ״דִּין וּדְבָרִים אֵין לִי עִמָּךְ בְּמָנֶה״.
...
> **Hebrew/Aramaic:** אִי הָכִי, אֵימָא סֵיפָא: שֶׁל מָאתַיִם וְשֶׁל שְׁלֹשׁ מֵאוֹת שָׁלֹשׁ שָׁלֹשׁ שֶׁל זָהָב. תֵּימָא לַהּ: הָא סַלֵּקְתְּ נַפְשִׁךְ מִינַּהּ!
...
> **Hebrew/Aramaic:** הָיוּ שָׁם שְׁלֹשׁ מֵאוֹת וְכוּ׳.
...
> **Hebrew/Aramaic:** רַב יַעֲקֹב מִנְּהַר פְּקוֹד מִשְּׁמֵיהּ דְּרָבִינָא אָמַר: רֵישָׁא בִּשְׁתֵּי תְפִיסוֹת, וְסֵיפָא בִּשְׁתֵּי תְפִיסוֹת.
...
> **Hebrew/Aramaic:** רֵישָׁא בִּשְׁתֵּי תְפִיסוֹת — דְּנָפְלוּ שִׁבְעִין וַחֲמִשָּׁה בְּחַד זִימְנָא, וּמֵאָה וְעֶשְׂרִים וַחֲמִשָּׁה בְּחַד זִימְנָא.
...
> **Hebrew/Aramaic:** סֵיפָא בִּשְׁתֵּי תְפִיסוֹת — דְּנָפְלוּ שִׁבְעִים וַחֲמִשָּׁה בְּחַד זִימְנָא, וּמָאתַיִם וְעֶשְׂרִים וַחֲמִשָּׁה בְּחַד זִימְנָא.
> **Translation:** **The latter clause,** where three hundred dinars were available, is also referring to a case **where** there were **two seizures** of property, **as seventy-five** dinars **became available** to them **at one time and two hundred and twenty-five** dinars **at another time.**
...
> **Hebrew/Aramaic:** תַּנְיָא: זוֹ מִשְׁנַת רַבִּי נָתָן. רַבִּי אוֹמֵר: אֵין אֲנִי רוֹאֶה דְּבָרָיו שֶׁל רַבִּי נָתָן בְּאֵלּוּ, אֶלָּא חוֹלְקוֹת בְּשָׁוֶה.
...
What *cholkim b'shaveh* means is itself not obvious. One reading takes it literally: divide everything equally, full stop — so that in the case of an estate of 300 with claims of 100, 200, and 300, each woman simply receives 100. A second reading, advanced by Tosafot, is more nuanced: *cholkim b'shaveh* means you apply the *Bava Metzia* model of dividing what is genuinely contested, but without Aumann's layered mathematical structure. On this reading, the estate is divided equally among all claimants up to the point where a smaller claimant's full claim is satisfied, at which point that claimant steps out and the remainder is divided equally among those still in contest. In the case of the estate of 200 with claims of 100, 200, and 300, the first 100 would be divided equally among all three, and the remaining 100 divided equally between the two whose claims are not yet exhausted — yielding roughly 33, 83, 83. In the case of 300, the same logic applied across three tiers yields roughly 33, 83, 183. The contrast with Rabbi Natan's graduated system is real, and it is genuinely unclear which of these two interpretations of *cholkim b'shaveh* Rabbi intends.

What makes Rabbi's statement striking is that he is the *mesader ha-mishna* — the very person who arranged and codified the *Mishnah* — and yet here, in a *baraita*, he explicitly distances himself from the anonymous ruling he enshrined. This tension is taken up directly in the next section.
...
> **Hebrew/Aramaic:** וְכֵן שְׁלֹשָׁה שֶׁהֵטִילוּ. אָמַר שְׁמוּאֵל: שְׁנַיִם שֶׁהִטִּילוּ לְכִיס, זֶה מָנֶה וְזֶה מָאתַיִם —
...
> **Hebrew/Aramaic:** הַשָּׂכָר לָאֶמְצַע.
> **Translation:** **the earnings are divided equally.**
...
> **Hebrew/Aramaic:** אָמַר רַבָּה: מִסְתַּבְּרָא מִילְּתֵיהּ דִּשְׁמוּאֵל בְּשׁוֹר לַחֲרִישָׁה וְעוֹמֵד לַחֲרִישָׁה, אֲבָל בְּשׁוֹר לַחֲרִישָׁה וְעוֹמֵד לִטְבִיחָה — זֶה נוֹטֵל לְפִי מְעוֹתָיו וְזֶה נוֹטֵל לְפִי מְעוֹתָיו. וְרַב הַמְנוּנָא אָמַר: אֲפִילּוּ שׁוֹר לַחֲרִישָׁה וְעוֹמֵד לִטְבִיחָה — הַשָּׂכָר לָאֶמְצַע.
...
> **Hebrew/Aramaic:** מֵיתִיבִי: שְׁנַיִם שֶׁהִטִּילוּ לַכִּיס, זֶה מָנֶה וְזֶה מָאתַיִם — הַשָּׂכָר לָאֶמְצַע. מַאי לָאו, בְּשׁוֹר לַחֲרִישָׁה וְעוֹמֵד לִטְבִיחָה, וּתְיוּבְתָּא דְּרַבָּה? לָא, בְּשׁוֹר לַחֲרִישָׁה וְעוֹמֵד לַחֲרִישָׁה.
...
> **Hebrew/Aramaic:** תְּנַן: וְכֵן שְׁלֹשָׁה שֶׁהִטִּילוּ לַכִּיס, פִּחֲתוּ אוֹ הוֹתִירוּ — כָּךְ הֵן חוֹלְקִין,
...
> **Hebrew/Aramaic:** מַאי לָאו: ״פִּחֲתוּ״ — פִּחֲתוּ מַמָּשׁ, ״הוֹתִירוּ״ — הוֹתִירוּ מַמָּשׁ!
